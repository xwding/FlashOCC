...
def main():
    ...
    for cnt, info in enumerate(
        ...
        gt_data = np.load(os.path.join("/media/dxw/bacc88ab-8909-4a30-a90c-1815997d26163/dxw/occ/nuscenes/nuscenes/train/occ_3d/gts/scene-0001/1e19d0a5189b46f4b62aa47508f2983e", 'labels.npz'))
        
        voxel_label = gt_data['semantics']
        pred_occ = voxel_label.copy()
